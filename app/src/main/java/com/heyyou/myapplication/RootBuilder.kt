...
class RootBuilder(dependency: ParentComponent) :
    ...
    abstract class Module {
        @RootScope
        @Binds
        internal abstract fun fullScreenView(view: RootView): FullScreenView
        @RootScope
        @Binds
        ...
        companion object {
            ...
            internal fun router(
              ...
              interactor: RootInteractor
                ...
                return RootRouter(view, interactor, component, CoordinatorBuilder(component))
            }
        }
    ...
    interface Component : InteractorBaseComponent<RootInteractor>, CoordinatorBuilder.ParentComponent, BuilderComponent {
